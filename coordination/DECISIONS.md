...
Computer 1 maintains this after explicit human choices. Other lanes recommend in their own files.

| Item | State | Human direction |
| --- | --- | --- |
| First deck and approach | REJECTED | Patrick rejected the starting point |
| Assigned prompt | FIXED | Orbital data centers for truck stops as an airline loyalty program secretly comprising the whole business |
| Workflow | FIXED | Three people / computers / models; GitHub source of truth |
| Handoff | FIXED | Update GitHub after every substantive model run |
...
| Final script / slide order / PDF | OPEN | No approved replacement yet |
